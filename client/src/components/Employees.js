                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center" onClick={handleOpen}>{renderEditButton('Edit')}</TableCell>
                      <TableCell align="center">{renderEditButton('Delete')}</TableCell>
                      <TableCell align="center">{renderEditButton('Add Review')}</TableCell>
