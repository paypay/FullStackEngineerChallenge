...
export class LandingComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.subscriber.push(this.authenticateService.userData.subscribe(data => {
      if (data) {
    ...
    this.subscriber.push(this.sn.panelClose$.subscribe(data => {
   ...
   */
   ngOnDestroy() {
    this.subscriber.map(s => s.unsubscribe);    
  }
   ...
   */
  fetchData(id) {
    this.subscriber.push(this.empService.fetchEmployeeData(id).subscribe(data => {
